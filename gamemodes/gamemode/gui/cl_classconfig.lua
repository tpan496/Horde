...
function PANEL:Init()
    ...
    local basic_cat = modify_tab:Add(translate.Get("Class_Configuration_Tab_Basic"))
    ...
    local perks_cat = modify_tab:Add(translate.Get("Class_Configuration_Tab_Perks"))
    ...
    local function create_property_editor(name, height, cat_panel)
        ...
        label:SetText(translate.Get("Class_Configuration_Entity_Stuff_" .. name) or name)
        ...
        elseif name == "Tier 1" or name == "Tier 2" or name == "Tier 3" or name == "Tier 4" then
            ...
            label_left:SetText(translate.Get("Class_Configuration_Tiers_Perk_Left"))
            ...
            label_right:SetText(translate.Get("Class_Configuration_Tiers_Perk_Right"))
        ...
        elseif name == "player model" then
            ...
            eg:SetPos(290, 0)
            eg:SetText(translate.Get("Class_Configuration_Player_Model_Example"))
    ...
    local name_editor = create_property_editor(translate.Get("Class_Configuration_Entity_Stuff_" .. "class name"), 50, basic_panel)
    local display_name_editor = create_property_editor(translate.Get("Class_Configuration_Entity_Stuff_" .. "display name"), 50, basic_panel)
    local description_editor = create_property_editor(translate.Get("Class_Configuration_Entity_Stuff_" .. "extra description"), 200, basic_panel)
    local model_editor = create_property_editor(translate.Get("Class_Configuration_Entity_Stuff_" .. "player model"), 50, basic_panel)
    local icon_editor = create_property_editor(translate.Get("Class_Configuration_Entity_Stuff_" .. "icon"), 50, basic_panel)
    local perks0_editor = create_property_editor(translate.Get("Class_Configuration_Entity_Stuff_" .. "Tier 0"), 50, perks_panel)
    local perks1_editors = create_property_editor(translate.Get("Class_Configuration_Entity_Stuff_" .. "Tier 1"), 120, perks_panel)
    local perks2_editors = create_property_editor(translate.Get("Class_Configuration_Entity_Stuff_" .. "Tier 2"), 120, perks_panel)
    local perks3_editors = create_property_editor(translate.Get("Class_Configuration_Entity_Stuff_" .. "Tier 3"), 120, perks_panel)
    local perks4_editors = create_property_editor(translate.Get("Class_Configuration_Entity_Stuff_" .. "Tier 4"), 120, perks_panel)
    ...
    if GetConVarNumber("horde_default_class_config") == 1 then
        ...
        warning_label:SetText(translate.Get("Class_Configuration_Tiers_Notice"))
    ...
    save_btn:Dock(TOP)
    save_btn:SetText(translate.Get("Class_Configuration_Button_Save"))
    save_btn:SetTall(30)
    ...
    reset_btn:SetText(translate.Get("Class_Configuration_Button_Reset_Class_List"))
    ...
    class_list:AddColumn(translate.Get("Class_Configuration_List_Display_Name"))
    class_list:AddColumn(translate.Get("Class_Configuration_List_Description"))
    ...
    class_list.OnClickLine = function(parent, line, selected)
        ...
        menu:AddOption(translate.Get("Class_Configuration_Button_Modify"), function()
...
function PANEL:Think()
    ...
    for i, line in pairs(lines) do
        if table.HasValue(HORDE.classes, line.class) then
            ...
            line:SetValue(1, translate.Get("Class_" .. class.display_name) or class.display_name)
            line:SetValue(2, translate.Get("Class_Description_" .. class.display_name) or class.extra_description)
        else
...
function PANEL:Paint(w, h)
    ...
    draw.SimpleText(translate.Get("Class_Configuration_Title"), "Trebuchet24", 10, 22, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
end
