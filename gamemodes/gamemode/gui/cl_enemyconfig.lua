...
function PANEL:Init()
    ...
    local required_cat = modify_tab:Add(translate.Get("Enemy_Configuration_Tab_Required"))
    ...
    local basic_modifier_cat = modify_tab:Add(translate.Get("Enemy_Configuration_Tab_Basic_Modifiers"))
    ...
    local elite_modifier_cat = modify_tab:Add(translate.Get("Enemy_Configuration_Tab_Elite_Boss_Modifiers"))
    ...
    local mut_modifier_cat = modify_tab:Add(translate.Get("Enemy_Configuration_Tab_Mutation_Modifiers"))
    ...
    local function create_property_editor(name, height, cat_panel)
        ...
        label:SetText(translate.Get("Enemy_Configuration_Entity_Stuff_" .. name))
        ...
        if name == "class" then
            ...
            manual_toggle:SetText(translate.Get("Enemy_Configuration_Required_Class_Manual_Input"))
        ...
        elseif name == "color" then
            ...
            editor1:Dock(LEFT)
            editor1:SetText(translate.Get("Enemy_Configuration_Basic_Modifiers_Use_Color"))
        ...
        elseif name == "is boss" then
            ...
            end_wave_editor:SetText(translate.Get("Enemy_Configuration_Elite_Boss_Modifiers_End_Wave_After_Lose"))
            ...
            unlimited_enemies_spawn_editor:SetText(translate.Get("Enemy_Configuration_Elite_Boss_Modifiers_Unlimited_Enemies_During_Wave"))
            ...
            enemies_spawn_threshold_label:SetText(translate.Get("Enemy_Configuration_Elite_Boss_Modifiers_Spawn_Enemies_After_Health_Dropped_To_X_Health1"))
            ...
            enemies_spawn_threshold_percentage_label:SetText(translate.Get("Enemy_Configuration_Elite_Boss_Modifiers_Spawn_Enemies_After_Health_Dropped_To_X_Health2"))
            ...
            music_label:SetText(translate.Get("Enemy_Configuration_Elite_Boss_Modifiers_Boss_Music"))
            ...
            music_duration_label:SetText(translate.Get("Enemy_Configuration_Elite_Boss_Modifiers_Boss_Music_Duration"))
            ...
            boss_note_label:SetText(translate.Get("Enemy_Configuration_Elite_Boss_Modifiers_Boss_Kill_Reward_Notice"))
        ...
        elseif name == "mutation" then
            ...
            mut_label:SetSize(350, height/2)
            mut_label:SetPos(110, 40)

            function editor:OnSelect(index, value, data)
                if value == "" then
                    mut_label:SetText(translate.Get("Enemy_Configuration_Mutation_Modifiers_No_Mutation_Description"))
                else
                    mut_label:SetText(translate.Get("Mutation_Description_" .. MUTATION.ClassName) or HORDE.mutations[value])
                end
            end
        ...
        elseif name == "spawn limit" then
            ...
            warning_label:SetText(translate.Get("Enemy_Configuration_Basic_Modifiers_Spawn_Limit_Notice"))
    ...
    local name_editor = create_property_editor(translate.Get("Enemy_Configuration_Entity_Stuff_" .. "name"), 35, required_panel)
    local class_editor = create_property_editor(translate.Get("Enemy_Configuration_Entity_Stuff_" .. "class"), 35, required_panel)
    local weight_editor = create_property_editor(translate.Get("Enemy_Configuration_Entity_Stuff_" .. "spawn weight"), 35, required_panel)
    local wave_editor = create_property_editor(translate.Get("Enemy_Configuration_Entity_Stuff_" .. "wave"), 35, required_panel)

    local health_editor = create_property_editor(translate.Get("Enemy_Configuration_Entity_Stuff_" .. "health scaling"), 35, basic_modifier_panel)
    local damage_editor = create_property_editor(translate.Get("Enemy_Configuration_Entity_Stuff_" .. "damage scaling"), 35, basic_modifier_panel)
    local reward_editor = create_property_editor(translate.Get("Enemy_Configuration_Entity_Stuff_" .. "reward scaling"), 35, basic_modifier_panel)
    local model_scale_editor = create_property_editor(translate.Get("Enemy_Configuration_Entity_Stuff_" .. "model scaling"), 35, basic_modifier_panel)
    local weapon_editor = create_property_editor(translate.Get("Enemy_Configuration_Entity_Stuff_" .. "weapon"), 35, basic_modifier_panel)
    local skin_editor = create_property_editor(translate.Get("Enemy_Configuration_Entity_Stuff_" .. "skin"), 35, basic_modifier_panel)
    local model_editor = create_property_editor(translate.Get("Enemy_Configuration_Entity_Stuff_" .. "model override"), 35, basic_modifier_panel)
    local spawn_limit_editor = create_property_editor(translate.Get("Enemy_Configuration_Entity_Stuff_" .. "spawn limit"), 35, basic_modifier_panel)
    local color_editor = create_property_editor(translate.Get("Enemy_Configuration_Entity_Stuff_" .. "color"), 130, basic_modifier_panel)
    
    local elite_editor = create_property_editor(translate.Get("Enemy_Configuration_Entity_Stuff_" .. "is elite"), 35, elite_modifier_panel)
    local boss_editors = create_property_editor(translate.Get("Enemy_Configuration_Entity_Stuff_" .. "is boss"), 140, elite_modifier_panel)

    local mut_editor = create_property_editor(translate.Get("Enemy_Configuration_Entity_Stuff_" .. "mutation"), 100, mut_modifier_panel)
    ...
    if GetConVarNumber("horde_default_enemy_config") == 1 or (GetConVarString("horde_external_lua_config") and GetConVarString("horde_external_lua_config") ~= "") then
        ...
        warning_label:SetText(translate.Get("Enemy_Configuration_Mutation_Modifiers_Warning"))
    end
    ...
    save_btn:SetText(translate.Get("Enemy_Configuration_Button_Save_Enemy"))
    save_btn:SetTall(30)
    ...
    save_btn.DoClick = function ()
        ...
        net.SendToServer()
        notification.AddLegacy(translate.Get("Notification_Your_Changes_Have_Been_Saved"), NOTIFY_GENERIC, 5)
    end
    ...
    to_label:SetText(translate.Get("Enemy_Configuration_Button_Copy_From_Wave_A_To_Wave_B_Select_To"))
    ...
    save_after_btn:SetText(translate.Get("Enemy_Configuration_Button_Copy_From_Wave_A_To_Wave_B"))
    ...
    load_btn:SetText(translate.Get("Enemy_Configuration_Button_Overwrite_With_Default"))
    load_btn:SetTall(30)
    load_btn.DoClick = function ()
        Derma_Query(translate.Get("Enemy_Configuration_Button_Overwrite_With_Default_Dialogue"), translate.Get("Enemy_Configuration_Button_Overwrite_With_Default_Dialogue_Title"),
    ...
    load_defaut_btn:SetText(translate.Get("Enemy_Configuration_Button_Add_Default_Enemies"))
    load_defaut_btn.DoClick = function ()
        Derma_Query(translate.Get("Enemy_Configuration_Button_Add_Default_Enemies_Dialogue"), translate.Get("Enemy_Configuration_Button_Add_Default_Enemies_Dialogue_Title"),
            translate.Get("Shop_Confirmation_Dialogue_Yes"),
            function()
                HORDE:GetDefaultEnemiesData()
    ...
    del_btn:SetText(translate.Get("Enemy_Configuration_Button_Delete_Everything"))
    del_btn:SetTall(30)
    del_btn.DoClick = function ()
        Derma_Query(translate.Get("Enemy_Configuration_Button_Delete_Everything_Dialogue"), translate.Get("Enemy_Configuration_Button_Delete_Everything_Dialogue_Title"),
            translate.Get("Shop_Confirmation_Dialogue_Yes"),
            function()
                HORDE.enemies = {}
    ...
    enemy_list:AddColumn(translate.Get("Enemy_Configuration_List_Wave"))
    enemy_list:AddColumn(translate.Get("Enemy_Configuration_List_Name"))
    enemy_list:AddColumn(translate.Get("Enemy_Configuration_List_Class"))
    enemy_list:AddColumn(translate.Get("Enemy_Configuration_List_Weight"))
    ...
    enemy_list.OnClickLine = function(parent, line, selected)
        ...
        menu:AddOption(translate.Get("Enemy_Configuration_Button_Modify"), function()
        ...
        menu:AddOption(translate.Get("Enemy_Configuration_Button_Delete"), function()
...
function PANEL:Think()
    ...
    for i, line in pairs(lines) do
        if table.HasValue(HORDE.enemies, line.enemy) then
            ...
            line:SetValue(2, translate.Get("Enemy_Name_" .. enemy.name) or enemy.name)
