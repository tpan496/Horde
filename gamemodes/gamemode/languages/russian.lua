...
LANGUAGE["Game_Players_Ready_X"] = "Готовые игроки: %s"
...
LANGUAGE["Game_Remaining_Time_X"] = "Время: %s"
...
LANGUAGE["Damage_Type_Fire"] = "Огонь"
-- Ranks
...
ПП-19 «Бизон».
Предлагает магазин большой ёмкости, который быстро перезаряжается.
]]
