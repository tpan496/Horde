...
function PANEL:Init()
    ...
    whitelist_label:SetText(translate.Get("Map_Configuration_Whitelist_Settings"))
    ...
    whitelist_eg_label:SetText(translate.Get("Map_Configuration_Whitelist_Example"))
    ...
    whitelist_btn:SetText(translate.Get("Map_Configuration_Whitelist_Add_Map"))
    ...
    whitelist_del_btn:SetText(translate.Get("Map_Configuration_Delete_Whitelist"))
    whitelist_del_btn.DoClick = function ()
        Derma_Query(translate.Get("Map_Configuration_Delete_Whitelist_Dialogue"), translate.Get("Map_Configuration_Delete_Whitelist_Dialogue_Title"),
    ...
    whitelist_list:AddColumn(translate.Get("Map_Configuration_List_Maps"))
    ...
    whitelist_list.OnClickLine = function(parent, line, selected)
        ...
        menu:AddOption(translate.Get("Map_Configuration_Button_Modify"), function()
            whitelist_editor:SetText(map)
        end)

        menu:AddOption(translate.Get("Map_Configuration_Button_Delete"), function()
    ...
    blacklist_label:SetText(translate.Get("Map_Configuration_Blacklist_Settings"))
    ...
    blacklist_eg_label:SetText(translate.Get("Map_Configuration_Blacklist_Example"))
    ...
    blacklist_btn:SetText(translate.Get("Map_Configuration_Blacklist_Add_Map"))
    ...
    blacklist_del_btn:SetText(translate.Get("Map_Configuration_Delete_Blacklist"))
    blacklist_del_btn.DoClick = function ()
        Derma_Query(translate.Get("Map_Configuration_Delete_Blacklist_Dialogue"), translate.Get("Map_Configuration_Delete_Blacklist_Dialogue_Title"),
            translate.Get("Shop_Confirmation_Dialogue_Yes"),
            function()
                HORDE.map_blacklist = {}
    ...
    blacklist_list:AddColumn(translate.Get("Map_Configuration_List_Maps"))
...
function PANEL:Paint(w, h)
    ...
    draw.SimpleText(translate.Get("Map_Configuration_Title"), "Trebuchet24", 10, 22, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
end
