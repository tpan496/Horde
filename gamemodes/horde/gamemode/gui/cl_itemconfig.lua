...
function PANEL:Init()
    ...
    local entity_type_cat = modify_tab:Add(translate.Get("Item_Configuration_Tab_Entity_Type"))
    ...
    local entity_properties_cat = modify_tab:Add(translate.Get("Item_Configuration_Tab_Entity_Properties"))
    ...
    local starter_properties_cat = modify_tab:Add(translate.Get("Item_Configuration_Tab_Starter_Class"))
    ...
    local function create_property_editor(name, height, cat_panel, categories)
        ...
        label:SetText(translate.Get("Item_Configuration_Entity_Stuff_" .. name) or name)
        ...
        elseif name == "class" then
            ...
            weapon_manual_toggle:SetText(translate.Get("Item_Configuration_Entity_Type_Class_Manual_Input"))
            ...
            arccw_attachment_editor:SetText(translate.Get("Item_Configuration_Entity_Type_Give_ArcCW_Attachment"))
            ...
            hor_label:SetText(translate.Get("Item_Configuration_Entity_Type_Drop_Position_X"))
            ...
            ver_label:SetText(translate.Get("Item_Configuration_Entity_Type_Drop_Position_Z"))
            ...
            yaw_label:SetText(translate.Get("Item_Configuration_Entity_Type_Drop_Position_Yaw"))
            ...
            limit_label:SetText(translate.Get("Item_Configuration_Entity_Type_Drop_Position_Limit"))
            ...
            entity_label:SetText(translate.Get("Item_Configuration_Entity_Type_entity"))
            ...
            for _, type in pairs(entity_types) do
                ...
                if type == "weapon_entity" then
                    checkbox:SetText(translate.Get("Item_Configuration_Entity_Type_weapon"))
                elseif type == "give_entity" then
                    checkbox:SetText(translate.Get("Item_Configuration_Entity_Type_give"))
                elseif type == "drop_entity" then
                    checkbox:SetText(translate.Get("Item_Configuration_Entity_Type_drop"))
                elseif type == "gadget_entity" then
                    checkbox:SetText(translate.Get("Item_Configuration_Entity_Type_gadget"))
                end
        ...
        elseif name == "levels" then
            local label = vgui.Create("DLabel", panel)
            label:SetText(translate.Get("Item_Configuration_Entity_Properties_levels_description"))
            label:SetTextColor(Color(0,0,0))
            label:SetPos(80,100)
            label:SetWide(600)
        ...
        elseif name == "starter class" then
            local label = vgui.Create("DLabel", panel)
            label:SetText(translate.Get("Item_Configuration_Starter_Class_Description1"))
            label:SetTextColor(Color(0,0,0))
            label:SetPos(90,50)
            label:SetTall(50)
            label:SetWide(250)
            ...
            label2:SetText(translate.Get("Item_Configuration_Starter_Class_Description2"))
    ...
    local class_editors = create_property_editor(translate.Get("Item_Configuration_Entity_Stuff_" .. "class"), 40 * 3, entity_type_panel)
    category_editor = create_property_editor(translate.Get("Item_Configuration_Entity_Stuff_" .. "category"), 35, entity_type_panel, weapon_categories)
    local name_editor = create_property_editor(translate.Get("Item_Configuration_Entity_Stuff_" .. "name"), 35, entity_type_panel)
    local price_editor = create_property_editor(translate.Get("Item_Configuration_Entity_Stuff_" .. "price"), 35, entity_properties_panel)
    local skull_tokens_editor = create_property_editor(translate.Get("Item_Configuration_Entity_Stuff_" .. "skull tokens"), 35, entity_properties_panel)
    weight_editor = create_property_editor(translate.Get("Item_Configuration_Entity_Stuff_" .. "weight"), 35, entity_properties_panel)
    description_editor = create_property_editor(translate.Get("Item_Configuration_Entity_Stuff_" .. "description"), 100, entity_properties_panel)
    local whitelist_editors = create_property_editor(translate.Get("Item_Configuration_Entity_Stuff_" .. "whitelist"), 40 * 2, entity_properties_panel)
    ammo_price_editor = create_property_editor(translate.Get("Item_Configuration_Entity_Stuff_" .. "ammo price"), 35, entity_properties_panel)
    secondary_ammo_price_editor = create_property_editor(translate.Get("Item_Configuration_Entity_Stuff_" .. "alt ammo price"), 35, entity_properties_panel)
    shop_icon_editor = create_property_editor(translate.Get("Item_Configuration_Entity_Stuff_" .. "shop icon"), 35, entity_properties_panel)
    level_editors = create_property_editor(translate.Get("Item_Configuration_Entity_Stuff_" .. "levels"), 150, entity_properties_panel)
    dmgtype_editors = create_property_editor(translate.Get("Item_Configuration_Entity_Stuff_" .. "damage type"), 100, entity_properties_panel)
    infusion_editors = create_property_editor(translate.Get("Item_Configuration_Entity_Stuff_" .. "infusions"), 100, entity_properties_panel)
    ...
    if GetConVarNumber("horde_default_item_config") == 1 or (GetConVarString("horde_external_lua_config") and GetConVarString("horde_external_lua_config") ~= "") then
        ...
        warning_label:SetText(translate.Get("Item_Configuration_Starter_Class_Warning"))
    ...
    save_btn:SetTall(30)
    save_btn:SetText(translate.Get("Item_Configuration_Button_Save_Item"))
    ...
    load_btn:SetTall(30)
    load_btn:SetText(translate.Get("Item_Configuration_Button_Overwrite_With_Default"))
    load_btn.DoClick = function ()
        Derma_Query(translate.Get("Item_Configuration_Button_Overwrite_With_Default_Dialogue"), translate.Get("Item_Configuration_Button_Overwrite_With_Default_Dialogue_Title"),
    ...
    load_defaut_btn:SetText(translate.Get("Item_Configuration_Button_Add_Default_Items"))
    load_defaut_btn.DoClick = function ()
        Derma_Query(translate.Get("Item_Configuration_Button_Add_Default_Items_Dialogue"), translate.Get("Item_Configuration_Button_Add_Default_Items_Dialogue_Title"),
            translate.Get("Shop_Confirmation_Dialogue_Yes"),
            function()
                HORDE:GetDefaultItemsData()
    ...
    gadget_btn:SetText(translate.Get("Item_Configuration_Button_Add_Default_Gadgets"))
    gadget_btn.DoClick = function ()
        Derma_Query(translate.Get("Item_Configuration_Button_Add_Default_Gadgets_Dialogue"), translate.Get("Item_Configuration_Button_Add_Default_Gadgets_Dialogue_Title"),
            translate.Get("Shop_Confirmation_Dialogue_Yes"),
            function()
    ...
    del_btn:SetTall(30)
    del_btn:SetText(translate.Get("Item_Configuration_Button_Delete_Everything"))
    del_btn.DoClick = function ()
        Derma_Query(translate.Get("Item_Configuration_Button_Delete_Everything_Dialogue"), translate.Get("Item_Configuration_Button_Delete_Everything_Dialogue_Title"),
            translate.Get("Shop_Confirmation_Dialogue_Yes"),
            function()
                HORDE.items = {}
    ...
    item_list:AddColumn(translate.Get("Item_Configuration_List_Class"))
    item_list:AddColumn(translate.Get("Item_Configuration_List_Category"))
    item_list:AddColumn(translate.Get("Item_Configuration_List_Name"))
    item_list:AddColumn(translate.Get("Item_Configuration_List_Price"))
    item_list:AddColumn(translate.Get("Item_Configuration_List_Weight"))
    ...
    item_list.OnClickLine = function(parent, line, selected)
        ...
        menu:AddOption(translate.Get("Item_Configuration_Button_Modify"), function()
            for type, checkbox in pairs(class_checkboxes) do
        ...
        menu:AddOption(translate.Get("Item_Configuration_Button_Delete"), function()
...
function PANEL:Think()
    ...
    for i, line in pairs(lines) do
        if table.HasValue(HORDE.items, line.item) then
            ...
            line:SetValue(3, translate.Get("Item_" .. item.name) or item.name)
