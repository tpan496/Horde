...
att.PrintName = "Incendiary Launcher (Horde)"
...
att.AutoStats = true
att.Slot = "horde_ubgl_incendiary"
...
att.AddSuffix = " Incendiary Grenadier"
...
att.UBGL_Fire = function(wep, ubgl)
    ...
    wep:FireRocket("horde_projectile_incendiary_round", 100000)
...
ArcCW.LoadAttachmentType(att, "horde_ubgl_incendiary")