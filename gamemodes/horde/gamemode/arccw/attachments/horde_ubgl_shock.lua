...
att.PrintName = "Shock Launcher"
att.Icon = Material("entities/acwatt_mw2_ubgl_m203.png", "smooth")
att.Description = "Fires a Shock grenade that deals Lightning damage."
att.Desc_Pros = {
    "pro.ubgl",
}
att.Desc_Cons = {
...
att.UBGL_Fire = function(wep, ubgl)
    ...
    wep:FireRocket("horde_projectile_shock_round", 100000)
...
ArcCW.LoadAttachmentType(att, "horde_ubgl_shock")