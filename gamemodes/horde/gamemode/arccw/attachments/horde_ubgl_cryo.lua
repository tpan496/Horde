...
att.PrintName = "Cryo Launcher (Horde)"
...
att.UBGL_Fire = function(wep, ubgl)
    ...
    wep:FireRocket("horde_projectile_cryo_round", 100000)
...
ArcCW.LoadAttachmentType(att, "horde_ubgl_cryo")