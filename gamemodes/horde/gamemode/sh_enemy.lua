...
function HORDE:GetDefaultEnemiesData ()
    ...
    HORDE:CreateEnemy("Lesser Hunter", "npc_vj_ezo_archunter",                  0.05,  5, false, 0.75, 1, 1.3, 1)
    ...
    HORDE:CreateEnemy("Lesser Hunter", "npc_vj_ezo_archunter",                  0.05,  6, false, 1, 1, 1.25, 1)
    ...
    HORDE:CreateEnemy("Lesser Hunter", "npc_vj_ezo_archunter",                  0.05,  7, false, 1, 1, 1.25, 1)
    ...
    HORDE:CreateEnemy("Lesser Hunter", "npc_vj_ezo_archunter",                  0.05,  8, false, 1, 1, 1.2, 1)
    ...
    HORDE:CreateEnemy("Lesser Hunter", "npc_vj_ezo_archunter",                  0.05,  9, false, 1, 1, 1.2, 1)
