...
function translate.GetFont()
	return translate.Get("Default_Font") or "arial"
end

function translate.GetBoldFont()
	return translate.Get("Default_Font_Bold") or translate.Get("Default_Font") or "arial bold"
end
