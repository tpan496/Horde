...
Преобразует 85% урона от оружия в режущий урон.
...
Преобразует 85% урона от оружия в дробящий урон.
...
Преобразует 85% урона от оружия в урон от яда.
...
Преобразует 85% урона от оружия в урон от огня.
...
Преобразует 85% урона от оружия в урон от холода.
...
Преобразует 85% урона от оружия в урон от молнии.
...
Увеличивается урон от оружия в зависимости от вашего текущего накопления распада.
Увеличение урона на 5% за 10 накоплений распада, до 25%.

Увеличивается количество распада на 10 единиц в секунду, удерживая это оружие.
]]
