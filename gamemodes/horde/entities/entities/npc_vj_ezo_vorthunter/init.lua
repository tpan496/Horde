...
function ENT:MultipleMeleeAttacks()
		...
		if self:Visible(self:GetEnemy()) and self.RangeAttacking == false and self.MeleeAttacking == false and self.Alerting == false and self.Dodging == false and self.NearestPointToEnemyDistance > 500 and self.NearestPointToEnemyDistance < 1100 and CurTime() > self.NextCharge then
