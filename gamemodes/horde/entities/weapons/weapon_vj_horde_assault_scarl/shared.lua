...
SWEP.NPC_NextPrimaryFire 			= 0.09*13
SWEP.NPC_TimeUntilFire 				= 1
SWEP.NPC_TimeUntilFireExtraTimers	= {0.09, 0.09*2, 0.09*3, 0.09*4, 0.09*5, 0.09*6, 0.09*7, 0.09*8, 0.09*9, 0.09*10}

SWEP.NPC_HasReloadSound	= false

SWEP.NPC_HasSecondaryFire 		= true
SWEP.NPC_SecondaryFireEnt 		= "horde_projectile_cryo_round"
...
SWEP.Primary.Sound				= {")weapons/fesiugmw2/fire/scarl.wav"}
