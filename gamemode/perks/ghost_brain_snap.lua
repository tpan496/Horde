...
PERK.Hooks.Horde_OnPlayerDamage = function (ply, npc, bonus, hitgroup, dmginfo)
    ...
    if hitgroup == HITGROUP_HEAD then
        npc:Horde_AddDebuffBuildup(HORDE.Status_Frostbite, dmginfo:GetDamage() / 1.5, ply, dmginfo:GetDamagePosition())
    end
end
