...
PERK.Hooks.Horde_OnPlayerDamageTaken = function (ply, dmginfo, bonus)
    ...
    if ply:Armor() >= 5 and (dmginfo:GetDamageType() == DMG_NERVEGAS or dmginfo:GetDamageType() == DMG_ACID or dmginfo:GetDamageType() == DMG_POISON or dmginfo:GetDamageType() == DMG_BURN or dmginfo:GetDamageType() == DMG_BLAST) then
