...
LANGUAGE["Game_Players_Ready_X"] = "Hazir Oyuncular: %s"
...
LANGUAGE["Game_Remaining_Time_X"] = "Kalan Sure: %s"
...
LANGUAGE["Game_X_Damage"] = "%s Hasar"
LANGUAGE["Game_Most_Damage_Taken"] = "Alinan En Cok Hasar"
LANGUAGE["Game_X_Damage_Taken"] = "%s Alinan Hasar"
LANGUAGE["Game_Most_Kills"] = "En Cok Oldurme"
LANGUAGE["Game_X_Kills"] = "%s Oldurmeler"
LANGUAGE["Game_Elite_Killer"] = "Seckin Oldurucu"
LANGUAGE["Game_X_Elite_Kills"] = "%s Seckin Oldurmeler"
LANGUAGE["Game_SharpShooter"] = "KeskinNisanci"
LANGUAGE["Game_X_Headshots"] = "%s Kafadan vurus"
LANGUAGE["Game_Most_Heal"] = "Takım şifacı"
LANGUAGE["Game_X_Healed"] = "%s Iyilestin"
LANGUAGE["Game_X_Healed_You"] = "%s seni iyilestirdi."
...
LANGUAGE["Shop_Sell_For"] = "Bu kadara sat %s$"
LANGUAGE["Shop_Sell_All_For"] = "Hepsini bu kadara sat %s$"
