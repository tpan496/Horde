...
Бросается вперед, нанося режущий урон всем врагам на пути.

Активный Гаджет:
Наносит {1} режущего урона.
Неуязвим ко всем видам урона в течение {2} секунд во время броска.
У вас есть Фазирование на {3} секунд во время броска.
