...
Имеет доступ к снайперским винтовкам и некоторым лёгким вооружений.
...
Имеет доступ к подавителям и снайперским прицелам.]]
...
Вы наносите на {5} ольше урона при критическом попадании.
