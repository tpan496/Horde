...
function scoreboard:show()
    ...
    function title:Paint(w, h)
        draw.SimpleText(translate.Format("Scoreboard Map Info", game.GetMap(), translate.Get("Game_Difficulty_" .. HORDE.difficulty_text[HORDE.difficulty])), "Title", 0, 12, HORDE.color_crimson_dim, TEXT_ALIGN_LEFT)
