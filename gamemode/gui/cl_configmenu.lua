...
function PANEL:Init()
    ...
    itemconfig:SetText(translate.Get("Configuration_Menu_Item_Configuration"))
    ...
    enemyconfig:SetText(translate.Get("Configuration_Menu_Enemy_Configuration"))
    ...
    classconfig:SetText(translate.Get("Configuration_Menu_Class_Configuration"))
    ...
    mapconfig:SetText(translate.Get("Configuration_Menu_Map_Configuration"))
    ...
    stats:SetText(translate.Get("Configuration_Menu_Player_Information"))
...
function PANEL:Paint(w, h)
    ...
    draw.SimpleText(translate.Get("Configuration_Menu_Title"), "Trebuchet24", 10, 22, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
end
