...
function PANEL:Init()
    ...
    enemies_text_panel.Paint = function ()
        ...
        draw.SimpleText("Zombine convered in flames that are more suicidal. Resistant to Fire damage.", 'Content', 100, 550, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
        ...
        draw.SimpleText("Explodes on death, dealing Poison damage. Does not explode when decapitated. Weak to headshots. Resistant to Poison damage.", 'Content', 100, 800, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
        ...
        draw.SimpleText("Vomitters covered in flames. Spits burning flesh that deal Fire damage. Resistant to Fire damage.", 'Content', 100, 1000, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
        draw.SimpleText("Screecher", 'Heading', 50, 1050, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
        draw.SimpleText("Emits screaming shockwaves when approached. Deals Lightning damage. Resistant to Lightning damage.", 'Content', 100, 1100, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
        ...
        draw.SimpleText("Emits growling shockwaves when approached. Deals Cold damage. Resistant to Lightning and Cold damage.", 'Content', 100, 1200, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
        ...
        draw.SimpleText("Hulks that are experimented with dangerous mutations. Resistant to Cold damage.", 'Content', 100, 1400, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
