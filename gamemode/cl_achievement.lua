...
HORDE.MapAchievements = {
    normal = translate.Get("info_Achievements_Normal_Completion"),
    hard = translate.Get("info_Achievements_Hard_Completion"),
    realism = translate.Get("info_Achievements_Realism_Completion"),
    nightmare = translate.Get("info_Achievements_Nightmare_Completion"),
    apocalypse = translate.Get("info_Achievements_Apocalpyse_Completion"),
    coop = translate.Get("info_Achievements_Coop_Completion"),
    horde = translate.Get("info_Achievements_Horde_Completion"),
    hardcore_horde = translate.Get("info_Achievements_Hardcore_Completion"),
    coop_horde = translate.Get("info_Achievements_Coop_Horde_Completion"),
    hardcore_coop_horde = translate.Get("info_Achievements_Hardcore_Coop_Completion"),
    endless_20 = translate.Get("info_Achievements_Endless_Wave_20"),
    endless_30 = translate.Get("info_Achievements_Endless_Wave_30"),
}

HORDE.MapAchievement_Descriptions = {
    [HORDE.MapAchievements.normal] = translate.Get("info_Achievements_Normal_Completion_desc"),
    [HORDE.MapAchievements.hard] = translate.Get("info_Achievements_Hard_Completion_desc"),
    [HORDE.MapAchievements.realism] = translate.Get("info_Achievements_Realism_Completion_desc"),
    [HORDE.MapAchievements.nightmare] = translate.Get("info_Achievements_Nightmare_Completion_desc"),
    [HORDE.MapAchievements.apocalypse] = translate.Get("info_Achievements_Apocalpyse_Completion_desc"),
    [HORDE.MapAchievements.coop] = translate.Get("info_Achievements_Coop_Completion_desc"),
    [HORDE.MapAchievements.horde] = translate.Get("info_Achievements_Horde_Completion_desc"),
    [HORDE.MapAchievements.coop_horde] = translate.Get("info_Achievements_Coop_Horde_Completion_desc"),
    [HORDE.MapAchievements.hardcore_horde] = translate.Get("info_Achievements_Hardcore_Completion_desc"),
    [HORDE.MapAchievements.hardcore_coop_horde] = translate.Get("info_Achievements_Hardcore_Coop_Completion_desc"),
    [HORDE.MapAchievements.endless_20] = translate.Get("info_Achievements_Endless_Wave_20_desc"),
    [HORDE.MapAchievements.endless_30] = translate.Get("info_Achievements_Endless_Wave_30_desc"),
}
