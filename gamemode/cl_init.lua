...
center_panel:SetPos(ScrW() / 2 - 150, 25)
...
timer.Simple(5, function ()
	corner_panel.Paint = function ()
		...
		draw.SimpleText("Class: " .. LocalPlayer():GetClass().name .. " | Cash: " .. math.min(99999,LocalPlayer():GetMoney()) .. "$", "Trebuchet24", 150, 25, Color(255,255,255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	end
end)
