...
function HORDE:CreateEnemy(name, class, weight, wave, is_elite, health_scale, damage_scale, reward_scale, model_scale, color, weapon, spawn_limit, boss_properties, mutation, skin, model, spawn_min)
...
function HORDE:GetDefaultEnemiesData ()
    ...
    HORDE:CreateEnemy("Fast Zombie",      "npc_fastzombie",                 0.20,  2, false, 1, 1, 1, 1)
    ...
    HORDE:CreateEnemy("Fast Zombie",      "npc_fastzombie",                 0.20,  3, false, 1, 1, 1, 1)
    ...
    HORDE:CreateEnemy("Fast Zombie",      "npc_fastzombie",                 0.20,  4, false, 1, 1, 1, 1)
    ...
    HORDE:CreateEnemy("Fast Zombie",      "npc_fastzombie",                 0.20,  5, false, 1, 1, 1, 1)
    ...
    {is_boss=true, end_wave=true, unlimited_enemies_spawn=false, enemies_spawn_threshold=0.0, music="music/hl2_song20_submix0.mp3", music_duration=104}, "shielding")
    ...
    HORDE:CreateEnemy("Zombine", "npc_vj_horde_zombine",                    0.15,  6, false, 1, 1, 1.1, 1, nil,nil,nil,nil,nil,nil,nil,1)
    ...
    HORDE:CreateEnemy("Poison Zombie",  "npc_poisonzombie",                 0.20,  7, false, 1, 1, 1.1, 1)
    HORDE:CreateEnemy("Zombine", "npc_vj_horde_zombine",                    0.10,  7, false, 1, 1, 1.1, 1)
    HORDE:CreateEnemy("Charred Zombine", "npc_vj_horde_charred_zombine",    0.05,  7, false, 1, 1, 1.1, 1, nil,nil,nil,nil,nil,nil,nil,1)
    HORDE:CreateEnemy("Exploder", "npc_vj_horde_exploder",                  0.20,  7, true, 1, 1, 1.25, 1)
    ...
    HORDE:CreateEnemy("Lesion", "npc_vj_horde_lesion",                      0.04,  7, true, 1, 1, 2, 1, nil,nil,nil,nil,nil,nil,nil,1)
    ...
    HORDE:CreateEnemy("Fast Zombie",      "npc_fastzombie",                 0.20,  8, false, 1, 1, 1, 1)
    HORDE:CreateEnemy("Poison Zombie",  "npc_poisonzombie",                 0.20,  8, false, 1, 1, 1.1, 1)
    HORDE:CreateEnemy("Zombine", "npc_vj_horde_zombine",                    0.10,  8, false, 1, 1, 1.1, 1)
    HORDE:CreateEnemy("Charred Zombine", "npc_vj_horde_charred_zombine",    0.05,  8, false, 1, 1, 1.1, 1)
    HORDE:CreateEnemy("Exploder", "npc_vj_horde_exploder",                  0.20,  8, true, 1, 1, 1.25, 1)
    ...
    HORDE:CreateEnemy("Lesion", "npc_vj_horde_lesion",                      0.04,  8, true, 1, 1, 2, 1, nil,nil,nil,nil,nil,nil,nil,1)
    ...
    HORDE:CreateEnemy("Fast Zombie",      "npc_fastzombie",                 0.20,  9, false, 1, 1, 1, 1)
    HORDE:CreateEnemy("Poison Zombie",  "npc_poisonzombie",                 0.20,  9, false, 1, 1, 1, 1)
    HORDE:CreateEnemy("Zombine", "npc_vj_horde_zombine",                    0.10,  9, false, 1, 1, 1, 1)
    HORDE:CreateEnemy("Charred Zombine", "npc_vj_horde_charred_zombine",    0.05,  9, false, 1, 1, 1.25, 1)
    HORDE:CreateEnemy("Exploder", "npc_vj_horde_exploder",                  0.20,  9, true, 1, 1, 1.25, 1)
    ...
    HORDE:CreateEnemy("Lesion", "npc_vj_horde_lesion",                      0.04,  9, true, 1, 1, 2, 1, nil,nil,nil,nil,nil,nil,nil,2)
