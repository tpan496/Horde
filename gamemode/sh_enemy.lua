...
HORDE.GetDefaultEnemiesData = function ()
    ...
    HORDE.CreateEnemy("zombie poison vj", "npc_vj_zss_cpzombie", 0.25, 5, false, 1, 1, 1, 1, nil)
    HORDE.CreateEnemy("zombe panic 1", "npc_vj_zss_zp1", 0.25, 5, false, 1, 1, 1, 1, nil)
    ...
    HORDE.CreateEnemy("zombie poison vj", "npc_vj_zss_cpzombie", 0.25, 6, false, 1, 1, 1, 1, nil)
    HORDE.CreateEnemy("zombe panic 1", "npc_vj_zss_zp1",         0.25, 6, false, 1, 1, 1, 1, nil)
