...
HORDE.GetDefaultEnemiesData = function ()
    ...
    HORDE.CreateEnemy("zombie fast", "npc_fastzombie",           0.50, 6, false, 1, 1, 1, 1, nil)
    ...
    HORDE.CreateEnemy("zombie fast", "npc_fastzombie",           0.50, 7, false, 1, 1, 1, 1, nil)
    ...
    HORDE.CreateEnemy("zombie fast", "npc_fastzombie",           0.50, 8, false, 1, 1, 1, 1, nil)
    ...
    HORDE.CreateEnemy("zombie fast", "npc_fastzombie",           0.35, 9, false, 1, 1, 1, 1, nil)
    ...
    HORDE.CreateEnemy("zombie fast", "npc_fastzombie",               0.35, 10, false, 1, 1, 1, 1, nil)
