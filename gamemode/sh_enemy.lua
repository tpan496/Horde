...
HORDE.GetDefaultEnemiesData = function ()
    ...
    HORDE.CreateEnemy("zombe panic 1", "npc_vj_zss_zp1",         0.20, 5, false, 1.5, 1.5, 1, 1, nil)
    ...
    HORDE.CreateEnemy("zombe panic 1", "npc_vj_zss_zp1",         0.20, 6, false, 1.5, 1.5, 1, 1, nil)
    ...
    HORDE.CreateEnemy("zombe panic 1", "npc_vj_zss_zp1",         0.20, 7, false, 1.5, 1.5, 1, 1, nil)
    ...
    HORDE.CreateEnemy("zombe panic 1", "npc_vj_zss_zp1",         0.20, 8, false, 1.5, 1.5, 1, 1, nil)
    ...
    HORDE.CreateEnemy("zombe panic 1",    "npc_vj_zss_zp1",      0.20, 9, false, 1.5, 1.5, 1, 1, nil)
    ...
    HORDE.CreateEnemy("zombe panic 1",    "npc_vj_zss_zp1",          0.20, 10, false, 1.5, 1.5, 1, 1, nil)
