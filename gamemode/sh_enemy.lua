...
function HORDE:GetDefaultEnemiesData ()
    ...
    {is_boss=true, end_wave=true, unlimited_enemies_spawn=false, enemies_spawn_threshold=1.0, music="music/hl2_song20_submix0.mp3", music_duration=104}, "fume")
    HORDE:CreateEnemy("Slasher",  "npc_vj_slasher",                 1, 5, true, 1, 1, 10, 1.5, nil, nil, nil,
    ...
    HORDE:CreateEnemy("zombie hulk", "npc_vj_horde_hulk",        0.05, 6, true, 1, 1, 2, 1, nil)
    ...
    HORDE:CreateEnemy("zombie hulk", "npc_vj_horde_hulk",        0.05, 7, true, 1, 1, 2, 1, nil)
    HORDE:CreateEnemy("black zombie poison", "npc_poisonzombie", 0.20, 7, true, 1.25, 1.5, 1.5, 1.5, Color(0,0,0))
    HORDE:CreateEnemy("corruptor", "npc_vj_corruptor",           0.05, 7, true, 1, 1.5, 2, 1.5, nil, nil, nil, nil)
    ...
    HORDE:CreateEnemy("zombe panic 2", "npc_vj_zss_zp2",         0.10, 8, false, 1, 1, 1, 1, Color(50,255,50), nil, nil, nil, "decay")
    HORDE:CreateEnemy("red zombie fast", "npc_fastzombie",       0.15, 8, true, 1.25, 1.5, 1.25, 1.25, Color(255,0,0))
    HORDE:CreateEnemy("zombie hulk", "npc_vj_horde_hulk",        0.05, 8, true, 1, 1, 2, 1, nil)
    HORDE:CreateEnemy("black zombie poison", "npc_poisonzombie", 0.20, 8, true, 1.25, 1.5, 1.5, 1.5, Color(0,0,0))
    HORDE:CreateEnemy("corruptor", "npc_vj_corruptor",           0.05, 8, true, 1, 1.5, 2, 1.5, nil, nil, nil, nil)
    ...
    HORDE:CreateEnemy("zombe panic 2", "npc_vj_zss_zp2",         0.10, 9, false, 1, 1, 1, 1, Color(50,255,50), nil, nil, nil, "decay")
    HORDE:CreateEnemy("red zombie fast", "npc_fastzombie",       0.15, 9, true, 1.25, 1.5, 1.25, 1.25, Color(255,0,0))
    HORDE:CreateEnemy("zombie hulk", "npc_vj_horde_hulk",         0.05, 9, true, 1, 1, 2, 1, nil)
    ...
    HORDE:CreateEnemy("corruptor", "npc_vj_corruptor",           0.05, 9, true, 1, 1.5, 2, 1.5, nil, nil, nil, nil)
