...
HORDE.GetDefaultEnemiesData = function ()
    ...
    HORDE.CreateEnemy("zombie hulk", "npc_vj_zss_zhulk",         0.08, 5, true, 2, 2, 2, 1, nil)
    ...
    HORDE.CreateEnemy("zombie hulk", "npc_vj_zss_zhulk",         0.08, 6, true, 1, 1, 1, 1, nil)
    ...
    HORDE.CreateEnemy("zombie hulk", "npc_vj_zss_zhulk",         0.08, 7, true, 1, 1, 1, 1, nil)
    ...
    HORDE.CreateEnemy("red zombie fast", "npc_fastzombie",       0.50, 7, true, 1.25, 1.25, 1.25, 1.25, Color(255,0,0))
    ...
    HORDE.CreateEnemy("zombie vj fast black", "npc_vj_zss_cfastzombie", 0.05, 9, true, 2, 1, 2, 1.1, Color(0,0,0))
    ...
    HORDE.CreateEnemy("red zombie fast", "npc_fastzombie",       0.50, 7, true, 1.25, 1.25, 1.25, 1.25, Color(255,0,0))
    HORDE.CreateEnemy("zombie hulk red", "npc_vj_zss_zhulk",         0.05, 10, true, 2, 2, 2, 1, Color(255,0,0))
    HORDE.CreateEnemy("zombie hulk black", "npc_vj_zss_zhulk",       0.05,10, true, 3, 3, 2, 1, Color(0,0,0))
    ...
    HORDE.CreateEnemy("zombie vj fast black", "npc_vj_zss_cfastzombie", 0.05, 10, true, 2, 1, 2, 1.1, Color(0,0,0))
