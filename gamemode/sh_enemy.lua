...
HORDE.GetDefaultEnemiesData = function ()
    ...
    HORDE.CreateEnemy("zombie fast vj", "npc_vj_zss_cfastzombie",0.25, 6, false, 1, 1, 1, 1.25, nil)
    ...
    HORDE.CreateEnemy("zombie fast vj", "npc_vj_zss_cfastzombie",0.35, 7, false, 1, 1, 1, 1.25, nil)
    ...
    HORDE.CreateEnemy("zombie poison vj", "npc_vj_zss_cpzombie", 0.20, 8, false, 1, 1, 1, 1, nil)
    HORDE.CreateEnemy("zombie fast vj", "npc_vj_zss_cfastzombie",0.35, 8, false, 1, 1, 1, 1.25, nil)
    ...
    HORDE.CreateEnemy("zombie fast vj",   "npc_vj_zss_cfastzombie",0.35, 9, false, 1, 1, 1, 1.25, nil)
    ...
    HORDE.CreateEnemy("zombie fast vj", "npc_vj_zss_cfastzombie",    0.35, 10, false, 1, 1, 1, 1.25, nil)
    ...
    HORDE.CreateEnemy("zombie hulk red",  "npc_vj_zss_zhulk",        0.025, 10, true, 1.5, 1.5, 1.5, 1, Color(255,0,0))
    HORDE.CreateEnemy("zombie hulk black", "npc_vj_zss_zhulk",       0.025, 10, true, 1.5, 2, 2, 1, Color(0,0,0))
