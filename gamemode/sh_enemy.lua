...
function HORDE:GetDefaultEnemiesData ()
    ...
    HORDE:CreateEnemy("red zombie", "npc_zombie",                0.75, 3, true, 1.25, 1.25, 1.25, 1.25, Color(255,0,0), nil, nil, nil, "nemesis")
    ...
    HORDE:CreateEnemy("zombie poison vj", "npc_vj_vomitter", 0.5, 4, false, 1, 1, 1, 1, nil)
    ...
    {is_boss=true, end_wave=true, unlimited_enemies_spawn=false, enemies_spawn_threshold=1.0, music="music/hl2_song20_submix0.mp3", music_duration=104}, "regenerator")
    ...
    HORDE:CreateEnemy("zombie fast", "npc_fastzombie",           0.25, 6, false, 1, 1, 1, 1, nil)
    ...
    HORDE:CreateEnemy("zombie poison vj", "npc_vj_vomitter", 0.25, 7, false, 1, 1, 1, 1, nil)
    ...
    HORDE:CreateEnemy("corruptor", "npc_vj_corruptor",           0.05, 7, true, 2, 1.5, 2, 1.5, nil, nil, nil, nil, "fume")
    ...
    HORDE:CreateEnemy("zombie poison vj", "npc_vj_vomitter", 0.25, 8, false, 1, 1, 1, 1, nil)
    ...
    HORDE:CreateEnemy("corruptor", "npc_vj_corruptor",           0.05, 8, true, 2, 1.5, 2, 1.5, nil, nil, nil, nil, "fume")
    ...
    HORDE:CreateEnemy("zombie poison vj", "npc_vj_vomitter", 0.25, 9, false, 1, 1, 1, 1, nil)
    ...
    HORDE:CreateEnemy("corruptor", "npc_vj_corruptor",           0.05, 9, true, 2, 1.5, 2, 1.5, nil, nil, nil, nil, "fume")
