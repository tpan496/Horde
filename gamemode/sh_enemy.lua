...
HORDE.GetDefaultEnemiesData = function ()
    ...
    HORDE.CreateEnemy("zombie hulk", "npc_vj_zss_zhulk",         0.08, 8, true, 1, 1, 1, 1, nil)
    ...
    HORDE.CreateEnemy("zombie hulk", "npc_vj_zss_zhulk",         0.08, 9, true, 1, 1, 1, 1, nil)
    ...
    HORDE.CreateEnemy("zombie hulk red", "npc_vj_zss_zhulk",         0.08, 10, true, 2, 2, 2, 1, Color(255,0,0))
    HORDE.CreateEnemy("zombie hulk black", "npc_vj_zss_zhulk",       0.08,10, true, 3, 3, 2, 1, Color(0,0,0))
