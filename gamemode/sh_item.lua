...
function HORDE:GetDefaultItemsData()
    ...
    HORDE:CreateItem("Shotgun",    "SPAS-12",        "arccw_horde_spas12",2250, 7, "A standard 12-gauge shotgun.\nRMB to fire 2 shots at once.",
