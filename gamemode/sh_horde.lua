CreateConVar("horde_default_enemy_config", 1, SERVER_CAN_EXECUTE, "Use default enemy wave config settings.", 0, 1)
CreateConVar("horde_default_item_config", 1, SERVER_CAN_EXECUTE, "Use default item config settings.", 0, 1)
CreateConVar("horde_default_class_config", 1, SERVER_CAN_EXECUTE, "Use default class config settings.", 0, 1)
CreateConVar("horde_max_wave", 10, SERVER_CAN_EXECUTE, "Max waves.", 1, 10)
CreateConVar("horde_difficulty", 0, SERVER_CAN_EXECUTE, "Difficulty.", 0, 2)
CreateConVar("horde_break_time", 60, SERVER_CAN_EXECUTE, "Break time between waves.", 10, 60)
CreateConVar("horde_enable_shop", 1, SERVER_CAN_EXECUTE, "Enables shop menu or not.", 0, 1)
CreateConVar("horde_enable_client_gui", 1, SERVER_CAN_EXECUTE, "Enables client information ui or not.", 0, 1)
--CreateConVar("horde_enable_respawn", 0, SERVER_CAN_EXECUTE, "Players can respawn after death during a wave.")
CreateConVar("horde_max_spawn_distance", 2000, SERVER_CAN_EXECUTE, "Maximum enenmy respawn distance.", 100)
CreateConVar("horde_min_spawn_distance", 500, SERVER_CAN_EXECUTE, "Minimum enenmy respawn distance.", 0)
...
CreateConVar("horde_npc_cleanup", 1, SERVER_CAN_EXECUTE, "Kills all NPCs after a wave.", 0, 1)
CreateConVar("horde_enable_scoreboard", 1, SERVER_CAN_EXECUTE, "Enables built-in scoreboard.", 0, 1)
...
CreateConVar("horde_max_enemies_alive_base", 20, SERVER_CAN_EXECUTE, "Maximum number of living enemies (base).", 1)
CreateConVar("horde_max_enemies_alive_scale_factor", 5, SERVER_CAN_EXECUTE, "Scale factor of the maximum number of living enemies for multiplayer.", 0)
CreateConVar("horde_max_enemies_alive_max", 50, SERVER_CAN_EXECUTE, "Maximum number of maximum living enemies.", 1)
CreateConVar("horde_corpse_cleanup", 0, SERVER_CAN_EXECUTE, "Remove corpses.", 0, 1)
