...
if GetConVarNumber("horde_default_item_config") == 0 then
    ...
    {Medic=true, Assault=true, Heavy=true, Demolition=true, Survivor=true, Sniper=true, Engineer=true}, 10, -1)
    ...
    {Medic=true, Assault=true, Heavy=true, Demolition=true, Survivor=true, Sniper=false, Engineer=true}, 10, -1)
    ...
    {Medic=false, Assault=false, Heavy=false, Demolition=false, Survivor=true, Sniper=true, Engineer=true}, 10, -1)
    ...
    {Medic=true, Assault=true, Heavy=true, Demolition=true, Survivor=true, Sniper=false, Engineer=true}, 10, 75)
    ...
    {Medic=true, Assault=true, Heavy=true, Demolition=true, Survivor=true, Sniper=false, Engineer=true}, 10, -1)
    HORDE.CreateItem("SMG",        "Vector",         "arccw_mw2_vector",  2000, 6, "ES C90.\nA Belgian bullpup PDW with a magazine of 50 rounds.",
    {Medic=true, Assault=true, Heavy=false, Demolition=false, Survivor=true, Sniper=false, Engineer=false}, 10, -1)
    ...
    {Medic=false, Assault=true, Heavy=true, Demolition=false, Survivor=true, Sniper=false, Engineer=true}, 10, -1)
    ...
    {Medic=false, Assault=true, Heavy=true, Demolition=false, Survivor=true, Sniper=false, Engineer=false}, 10, -1)
    
    HORDE.CreateItem("Rifle",      "Combine AR2",    "weapon_ar2",        1500, 7, "Overwatch standard issue rifle.\nDark energy-powered assault rifle.",
    {Medic=false, Assault=true, Heavy=false, Demolition=false, Survivor=true, Sniper=false, Engineer=true}, 10, 50)
    ...
    {Medic=false, Assault=true, Heavy=false, Demolition=false, Survivor=true, Sniper=false, Engineer=false}, 10, -1)
    ...
    {Medic=false, Assault=false, Heavy=false, Demolition=false, Survivor=true, Sniper=true, Engineer=false}, 10, -1)
    ...
    {Medic=false, Assault=false, Heavy=false, Demolition=false, Survivor=false, Sniper=true, Engineer=false}, 10, -1)
    HORDE.CreateItem("Rifle",      "ACR",            "arccw_mw2_acr",     2250, 7, "Remington Adaptive Combat Rifle.\nA modular semi-Auto rifle.",
    {Medic=false, Assault=false, Heavy=false, Demolition=false, Survivor=true, Sniper=true, Engineer=false}, 10, -1)
    
    HORDE.CreateItem("MG",         "M249",           "arccw_go_m249para",  2250, 9, "M249 light machine gun.\nA gas operated and air-cooled weapon of destruction.",
    {Medic=false, Assault=false, Heavy=true, Demolition=false, Survivor=true, Sniper=false, Engineer=false}, 10, -1)
    ...
    {Medic=true, Assault=true, Heavy=true, Demolition=true, Survivor=true, Sniper=true, Engineer=true}, 75, -1)
    ...
    {Medic=false, Assault=false, Heavy=false, Demolition=true, Survivor=true, Sniper=false, Engineer=true}, 200, -1)
    HORDE.CreateItem("Explosive",  "Resistance RPG", "weapon_rpg",         2000, 7, "Laser-guided rocket propulsion device.",
    {Medic=false, Assault=false, Heavy=false, Demolition=true, Survivor=true, Sniper=false, Engineer=false}, 10, -1)
    ...
    {Medic=false, Assault=false, Heavy=false, Demolition=false, Survivor=false, Sniper=true, Engineer=true}, 10, -1)
    ...
    {Medic=false, Assault=false, Heavy=false, Demolition=false, Survivor=false, Sniper=false, Engineer=true}, 10, -1)
