...
ENT.RadiusDamage = 700 -- How much damage should it deal? Remember this is a radius damage, therefore it will do less damage the farther away the entity is from its enemy
...
function ENT:CustomOnPhysicsCollide(data, phys)
	self.Dead = true
	util.BlastDamage(self.Inflictor, self.Owner, self:GetPos(), 150, 700)
