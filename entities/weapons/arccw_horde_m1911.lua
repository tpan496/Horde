...
SWEP.PrintName = "Garrison 1911"
SWEP.Trivia_Class = "Pistol"
SWEP.Trivia_Desc = "Springfield Armory's adaptation of the venerable 1911.\nStandard-issue sidearm for the United States Armed Forces."
...
SWEP.Damage = 50
SWEP.DamageMin = 25
SWEP.Range = 350 * 0.085  -- GAME UNITS * 0.025 = METRES
SWEP.Penetration = 3
