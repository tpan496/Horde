...
function EFFECT:Think()
    ...
    if self.entity:IsWeapon() then
        if not self.entity.Mjollner_Charged then self.emitter:Finish() return false end
    else
        if not self.entity.Horde_Mutation_Charged then self.emitter:Finish() return false end
    end
